...
function initMap() {
  ...
  destinationMarker = generateMarker({ position: destinationLocation, icon: '/images/placemarker_red.png', title: 'Destination' })
...
function onLocationChange(dataSnapshot) {
  ...
  if (deliveryPersonMarker) {
    ...
    deliveryPersonMarker = generateMarker({
      ...
      icon: '/images/placemarker_blue.png', title: 'Delivery Person'
    })
  }
}
